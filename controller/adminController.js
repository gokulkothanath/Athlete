  ...
  const requestAccept = async (req, res) => {
    try {
      ...
      for (const orderItem of canceledOrder.items) {
       ...
       // console.log(orderItem.productId,orderItem.quantity);
...
const getChartData = async (req, res) => {
    try {
        ...
        // console.log(timeBaseForSalesChart, "timeBaseForSalesChart");
        // console.log(timeBaseForOrderNoChart, "timeBaseForOrderNoChart");
        // console.log(timeBaseForOrderTypeChart, "timeBaseForOrderTypeChart");
        // console.log(timeBaseForCategoryBasedChart, "timeBaseForCategoryBasedChart");
        ...
        // console.log("salesChartInfo:", salesChartInfo);
        // console.log("orderChartInfo:", orderChartInfo);
        // console.log("categoryBasedChartInfo:", categoryBasedChartInfo);
        // console.log("orderNoChartInfo:", orderNoChartInfo);
        ...
        // console.log(saleChartInfo,"saleChartInfo")
        // console.log(orderTypeChartInfo,"orderTypeChartInfo")
        // console.log(categoryChartInfo,"categoryChartInfo")
        // console.log(orderQuantityChartInfo,"orderQuantityChartInfo")
