    ...
    try {
      ...
      //  console.log(salesData,"salesData.....................")
        ...
        for(let i =0 ;i < salesData.length; i++){
            totalRegularPrice+=salesData[i].items.productPrice* salesData[i].items.quantity
...
const filterReoprt = async(req,res)=>{
    try {
      //  console.log(req.body)
        ...
        console.log(recievedData,"Timeperiodd")
    ...
    const filterCustomDateOrder = async(req,res)=>{
        try {
            ...
            console.log(totalRegularPrice,totalSalesPrice,totalDiscountPrice,"datassssssss")
